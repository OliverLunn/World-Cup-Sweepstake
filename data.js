...
// ==========================================
// Each player has an array of 2 teams they picked in the sweepstake. We will update these with actual team names once we fetch the data from the API
const sweepstakeData = [
    { player: "Philip", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Kimberley", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Oliver", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Felix", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Tabitha", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Florence", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "David", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Eilidh", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Joanne", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Tony", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Em", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Hannah", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Caz", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Maz", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Caz", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Malcolm", teams: ["TBD","TBD"], status: "In Tournament" },
    { player: "Frances", teams: ["TBD","TBD"], status: "In Tournament" }
];
